...
// 	printf("Number of fields = %i\nIdentifications = %s\nFrom ECU address = 0x%X", j1939_2.from_other_ecu_identifications.software_identification.number_of_fields, 
//                                                                                    j1939_2.from_other_ecu_identifications.software_identification.identifications, 
//                                                                                    j1939_2.from_other_ecu_identifications.software_identification.from_ecu_address);
